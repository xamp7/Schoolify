                          ...
                          .done(function( data ) {
                            ...
                            $(".studentsInfo").html("");
                              ...
                              $.each(data, function(i, item){
                                  ...
                                  $(".studentsInfo").append('<tr><td>'+x+'</td><td>'+item.name+'</td><td>'+item.fatherName+'</td><td> <input type="hidden" name="studentId[]" value="'+item.id+'" /><input type="checkbox" name="status[]" checked /></td></tr>');
                                  x++;
                              });
                          });
