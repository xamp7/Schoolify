    ...
    <div class="page-container">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="bdrs-3 ov-h bgc-white bd">
                                    ...
                                    <div class="pos-r">
                                        <button id="addAgenda" type="button" class="mT-nv-50 pos-a r-10 t-2 btn cur-p bdrs-50p p-0 w-3r h-3r btn-warning"><i class="ti-plus"></i></button>
            ...
            @section('footer_page')
              <script type="text/javascript">
                  $(document).on('click', '#addAgenda', function(e){
                      // e.preventDefault();
                        $.confirm({
                              title: 'Add Agenda',
