                          ...
                          <div id="root" class="row">
                                          <div class="col-md-12">
                                              <div class="bgc-white bd bdrs-3 p-20 mB-20">
                                                  <h4 class="c-grey-900 mB-20">Add Class</h4>
                                                      ...
                                                      {{ csrf_field() }}
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-2">
                                                              ...
                                                              <input type="text" class="form-control" id="inputPassword4" placeholder="Class" name="class">
                                                            </div>

                                                            <div class="form-group col-md-2">
                                                              <label for="inputPassword4">Maximum Strength</label>
                                                              <input type="text" class="form-control" id="inputPassword4" placeholder="Max Stength" name="totalStrength">
                                                            </div>
