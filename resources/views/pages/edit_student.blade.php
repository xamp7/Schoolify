                                                    ...
                                                    <form action="/edit_student" method="post">
                                                      ...
                                                      <div class="form-group row">
                                                        ...
                                                        <div class="form-group row">
                                                          ...
                                                          <div class="col-sm-5">
                                                            <input type="text" class="form-control" id="inputEmail3" placeholder="Father Name" name="fatherName" value="{{ $student->fatherName }}">
                                                            </div>
                                                          </div>
                                                              ...
                                                              <select class="form-control classes" name="classId">
                                                                <option value="0" selected>Select Class </option>
                                                                    @foreach($classes as $class)
                                                                      <option classId="{{ $class->id }}" {{ ($class->id == $student->class) ? 'selected' : '' }} >{{ $class->class }} </option>
                                                                   @endforeach
                                                              </select>
                                                             </div>
                                                              <div class="col-sm-3">
                                                                  ...
                                                                  <option value="0" selected>Select Section </option>
                                                                    @foreach($classes as $class)
                                                                      @foreach($class->sections as $section)
                                                                          <option class="section" classId="{{ $class->id }}" value="{{ $section->id }}" {{ ($student->secId == $section->id) ? 'selected' : '' }} > {{ $section->sec }}  </option>
                                                                      @endforeach
                                                                     @endforeach
                                                                </select>
                                                              </div>
                                                        ...
                                                        <div class="form-group row">
                                                          ...
                                                          <div class="col-sm-5">
                                                            <input type="text" class="form-control" id="inputEmail3" placeholder="Email" name="email" value="{{ $student->email }}">
                                                            </div>
                                                        </div>
                                                      ...
                                                      <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                          <input type="text" class="form-control" id="inputEmail3" placeholder="Phone" name="phone" value="{{ $student->phone }}">
                                                          </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                          ...
                                                          <div class="col-sm-5">
                                                            <textarea type="text" class="form-control" id="inputEmail3"  name="address">{{ $student->address }}</textarea>
                                                            </div>
                                                          </div>
                                                          ...
                                                          <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-5">
                                                              <input type="date" class="form-control" id="inputEmail3" name="joined" value="{{ \Carbon\Carbon::parse($student->joined)->format('Y-m-d') }}">
                                                              </div>
                                                            </div>
